...
const LoginBox = ({ isSignUp, setIsSignUp, user, setUser, password, setPassword, handleAction }) => {
  ...
  return (
    ...
    <img src={`${process.env.PUBLIC_URL}/assets/logo.png`} className="main-logo" alt="HONOR" style={{ width: '320px', height: 'auto', display: 'block', margin: '0 auto 20px' }} />      <h2 className="login-title">{isSignUp ? "إنشاء حساب ملكي جديد" : "دخول المنصة المحلية"}</h2>
